...
$ID = @$_GET['ID'];
$data = mysqli_query($koneksi,"SELECT * FROM cek WHERE ID='$ID'");
...
<html>
    <head>
        ...
        * {
        ...
        body {
            background: url('terupload/bgcek.jpeg') center center;
    ...
    <form action="" method="POST">
        ...
        <input type = "text" name="Ketersediaan" value="<?php echo $d['KetersediaanStok']; ?>" readonly>
